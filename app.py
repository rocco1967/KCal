...
st.sidebar.info('questa app e^ stata creata per conoscere le Kcalorie consumate dopo un esercizio fisico')
st.sidebar.info('                Created by Fascilla Gianfranco(Kaggle competitor)')
st.sidebar.info('Le specifiche del modello solo su^ richiesta')
